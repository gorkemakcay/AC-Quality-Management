...
namespace WebOS.Controllers.InputQuality
{
    public class InputQualityController : Controller
    {
        private readonly ILogger<InputQualityController> _logger;
        private readonly IAppUserService _AppUserService;
        private readonly UserManager<AppUser> _UserManager;

        public InputQualityController(ILogger<InputQualityController> logger,
